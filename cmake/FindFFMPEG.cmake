...
MACRO(FFMPEG_FIND varname shortname headername)
	...
	IF (FFMPEG_${varname}_LIBRARIES AND FFMPEG_${varname}_INCLUDE_DIRS)
		...
		# On Android, we need the parent include dir for #include <libavcodec/avcodec.h>
		# and the libavcodec include dir for #include <avcodec.h> (some engine parts do this)
		IF (ANDROID)
			SET(FFMPEG_${varname}_INCLUDE_DIRS ${FFMPEG_${varname}_INCLUDE_DIRS} ${FFMPEG_${varname}_INCLUDE_DIRS}/lib${shortname})
		ENDIF()
...
SET(FFMPEG_ROOT "${FFMPEG_ROOT}" CACHE PATH "Location of FFMPEG")

# If we have a unified 'ffmpeg' target (e.g. from parent project on Android)
IF (TARGET ffmpeg)
	SET(FFMPEG_FOUND 1)
	SET(FFMPEG_LIBRARIES ffmpeg)
	get_target_property(FFMPEG_INCLUDE_DIRS ffmpeg INTERFACE_INCLUDE_DIRECTORIES)
	SET(FFMPEG_LIBSWSCALE_LIBRARIES ffmpeg)
	SET(FFMPEG_LIBAVFILTER_LIBRARIES ffmpeg)
	SET(FFMPEG_LIBSWRESAMPLE_LIBRARIES ffmpeg)
	MESSAGE("Using unified FFmpeg target.")
ENDIF()
