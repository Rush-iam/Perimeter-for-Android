...
//This file contains parts of WINE project source code for d3dx9 licensed under GPLv2
    ...
    for (c = 0; c < 4; ++c)
    {
        ...
        if (format->bits[c])
        {
            ...
            if (format->type == FORMAT_ARGBF16) {
                ErrH.Abort("Unimplemented for FORMAT_ARGBF16");
                                         ...
                                         DWORD filter, D3DCOLOR color_key)
{
    ...
    {
        ErrH.Abort("Unsupported format %#x.\n", src_format);
        return E_NOTIMPL;
    }
